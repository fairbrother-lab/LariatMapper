...
if __name__ == '__main__':
	...
	bp_correction.add_argument('-P', '--pwm_correction', help='RDS file with a position weight matrix to correct apparent branchpoint positions. Multiple files can be provided in comma-seperated format. Mutually exclusive with --model_correction. See <ZENODO_LINK_TO_BE_ADDED> to download prebuilt matrices. See scripts/pwm_build.R to build a custom matrix (Default = no correction)')
